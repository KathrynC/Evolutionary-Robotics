...
Ludobots role:
  - Central Robot class that ties together body (URDF), joints, sensors, motors,
    and later neurons/synapses.
  - Provides the per-timestep update entry point used by the simulator (e.g., Robot.Act(t)).

Inputs:
  - body.urdf (generated by generate.py)
  - constants.py configuration
  - (optional) GAIT_VARIANT_PATH variant JSON when running experiments

Beyond Ludobots (this repo):
  - (Document your extended controller stack: gait variants, trajectory motors, telemetry, etc.)
"""
